...
public:
    explicit BusLine(const svg::Color color, const std::vector<svg::Point>& stops_point, const RenderSettings &r_);
    void Draw(svg::ObjectContainer &container) const override;
    svg::Color color_;
    std::vector<svg::Point> stops_point_;
    const RenderSettings &r_;
};

//--------------BusText-------------------------------------------------
class BusText : public svg::Drawable {
public:
    explicit BusText(const svg::Color color, const std::vector<svg::Point>& final_stops_position, const std::string_view bus_name, const RenderSettings &r_);
...
public:
    explicit StopCircle(const svg::Color color, const std::vector<svg::Point>& stops_point, const RenderSettings &r_);
    void Draw(svg::ObjectContainer &container) const override;
...
public:
    explicit StopText(const svg::Color color, const std::vector<svg::Point>& stops_position, const std::vector<std::string_view>& stops_name, const RenderSettings &r);
